  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center px-4 lg:px-12">
        ...
        {/* Desktop Navigation */}
        <div className="hidden md:flex items-center ml-auto bg-white shadow-lg rounded-tl-none rounded-bl-full lg:mx-7 lg:px-36 px-5 py-3">
          <nav className="hidden md:flex items-center space-x-6 lg:my-4 md:space-x-4">
            <NavLink
              to="/"
              className="text-gray-700 hover:border-b-4 decoration-4 hover:border-yellow-400 transition hover:font-bold"
            ...
            {user ? (
              <button
                ...
                className="text-white bg-red-600 hover:bg-red-500 text-md rounded-full px-4 py-2 lg:py-2 lg:px-7 lg:text-xl font-bold"
              >
                Logout
              </button>
            ) : (
              <Link to="/auth">
                <button className="text-white bg-gray-700 hover:bg-gray-500 text-md rounded-full px-4 py-2 lg:py-2 lg:px-7 lg:text-xl font-bold">
                  Login/Register
                </button>
              </Link>
            )}
          ...
          <nav className="flex flex-col items-center space-y-4 py-6">
            ...
            {user ? (
              <button
                ...
                className="text-white bg-red-600 hover:bg-red-500 text-md rounded-full px-4 py-2 transition"
              >
                Logout
              </button>
            ) : (
              <Link to="/auth" onClick={toggleMenu}>
                <button className="text-white bg-gray-700 hover:bg-gray-500 text-md rounded-full px-4 py-2 transition">
                  Login/Register
                </button>
              </Link>
            )}
